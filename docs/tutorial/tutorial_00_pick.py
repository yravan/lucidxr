...
if __name__ == "__main__":
    ...
    box = Body(
            ...
            <geom name="box-1" type="box" pos="0 0 0.7" size="0.015 0.015 0.015" rgba="1 0.5 0 1" density="10"/>
        """)
    work_area = Raw @ """
        <geom name="work-area" type="plane" pos="0 0 0.601" size="0.2 0.2 0.001" rgba="0 1 0 0.1" contype="0" conaffinity="0" density="0" />
        """
