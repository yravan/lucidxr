...
class KitchenDrawer(Body):
    ...
    # outer frame
    @property
    def sz_frame_tb(self):
        return self._box(self.w, 0.285, 0.015)

    @property
    def sz_frame_back(self):
        return self._box(self.w - 0.030, 0.015, 0.075)

    @property
    def sz_frame_side(self):
        return self._box(0.015, 0.285, 0.075)

    @property
    def off_outer(self):
        return f"{self.w - 0.015:.4f}"

    # inner sliding box
    @property
    def sz_inner_bot(self):
        return self._box(self.w - 0.031, 0.270, 0.015)

    @property
    def sz_inner_back(self):
        return self._box(self.w - 0.061, 0.015, 0.044)

    @property
    def sz_inner_side(self):
        return self._box(0.015, 0.270, 0.044)

    @property
    def off_inner(self):
        return f"{self.w - 0.031 * 1.5:.4f}"

    # face panel / horizontal trims
    @property
    def sz_face(self):
        return self._box(self.w - 0.0815, 0.0235, 0.005)

    @property
    def sz_trim_h(self):
        return self._box(self.w - 0.0815, 0.0400, 0.010)

    @property
    def off_face(self):
        return f"{self.w - 0.0415:.4f}"
