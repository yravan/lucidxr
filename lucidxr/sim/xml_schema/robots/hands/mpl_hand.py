...
class MPLRight(Body):
    assets: str = "robots/mpl"
    forearm_body: bool = False

    _attributes = {"name": "mpl-right", "axisangle": "0 0 1 3.141592", "childclass": "MPL"}
    ...
    _preamble = """
      ...
      <asset>
        <mesh name="index0" 	file="{assets}/collision/index0_collision.stl"/>
        <mesh name="index1" 	file="{assets}/collision/index1_collision.stl"/>
        <mesh name="index2" 	file="{assets}/collision/index2_collision.stl"/>
        <mesh name="index3" 	file="{assets}/collision/index3_collision.stl"/>
        <mesh name="middle0" 	file="{assets}/collision/middle0_collision.stl"/>
        <mesh name="middle1" 	file="{assets}/collision/middle1_collision.stl"/>
        <mesh name="middle2" 	file="{assets}/collision/middle2_collision.stl"/>
        <mesh name="middle3" 	file="{assets}/collision/middle3_collision.stl"/>
        <mesh name="palm" 		file="{assets}/collision/palm_collision.stl"/>
        <mesh name="pinky0" 	file="{assets}/collision/pinky0_collision.stl"/>
        <mesh name="pinky1" 	file="{assets}/collision/pinky1_collision.stl"/>
        <mesh name="pinky2" 	file="{assets}/collision/pinky2_collision.stl"/>
        <mesh name="pinky3" 	file="{assets}/collision/pinky3_collision.stl"/>
        <mesh name="ring0" 		file="{assets}/collision/ring0_collision.stl"/>
        <mesh name="ring1" 		file="{assets}/collision/ring1_collision.stl"/>
        <mesh name="ring2" 		file="{assets}/collision/ring2_collision.stl"/>
        <mesh name="ring3" 		file="{assets}/collision/ring3_collision.stl"/>
        <mesh name="thumb0" 	file="{assets}/collision/thumb0_collision.stl"/>
        <mesh name="thumb1" 	file="{assets}/collision/thumb1_collision.stl"/>
        <mesh name="thumb2" 	file="{assets}/collision/thumb2_collision.stl"/>
        <mesh name="thumb3" 	file="{assets}/collision/thumb3_collision.stl"/>
        <mesh name="wristx" 	file="{assets}/collision/wristx_collision.stl"/>
        <mesh name="wristy" 	file="{assets}/collision/wristy_collision.stl"/>
        <mesh name="wristz" 	file="{assets}/collision/wristz_collision.stl"/>
            
        <texture type="skybox" builtin="gradient" rgb1=".4 .6 .8" rgb2="0 0 0" width="100" height="100"/>
        <texture name="skin" type="cube" file="{assets}/texture/skin.png"/>
        <texture name="marble2d" type="2d" file="{assets}/texture/marble.png"/>
        <texture name="marblecube" type="cube" file="{assets}/texture/marble.png"/>
