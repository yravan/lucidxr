...
config = dict(
    ...
    env_name="BallSortingToy-color_random-v1",
    camera_keys=["wrist/rgb", "left/rgb", "right_r/rgb", "front/rgb"],
)

demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/ball_sorting_toy/2025/06/25/14.13.12/"
demo_ep_start = 1
demo_ep_end = 45
...
for i in [4, 5, 6, 8, 11, 12, 13, 15, 21, 22, 37, 38, 39, 41, 43]:
    mujoco_queue.add(
        dict(
            ep_ind=i,
