...
config = dict(
    ...
    env_name="TheFinalCalibrationEval-single_random-v1",
    camera_keys=["wrist/rgb", "left/rgb", "right/rgb"],
)

demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/the_final_calibration/2025/07/23/21.51.42_clone"
demo_ep_start = 1
demo_ep_end = 61
