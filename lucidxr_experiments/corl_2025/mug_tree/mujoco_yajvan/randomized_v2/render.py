...
# demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/06/27/17.31.03/"
demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/06/28/13.07.46/"
demo_ep_start = 46
demo_ep_end = 46
...
def main():
    ...
    for i in range(1, num_render_workers + 1, render_worker_chain_length):
        jaynes.config(mode="render", runner=dict(name=f"render_worker-{i}"), config_path="/Users/yajvanravan/fortyfive/lucidxr/.jaynes_fortyfive.yml")
