...
demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place/2025/06/18/16.50.36"
demo_ep_start = 1
demo_ep_end = 74

ignore = [30, 31]
ep_ids = [i for i in range(demo_ep_start, demo_ep_end+1) if i not in ignore]
