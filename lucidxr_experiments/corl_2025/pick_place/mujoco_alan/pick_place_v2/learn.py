...
with Sweep(RUN, TrainArgs, ACT_Config) as sweep:
    ...
    TrainArgs.dataset_prefix = [
        "lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place/2025/06/18/16.50.36/",
        "lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place/2025/06/19/02.21.34/",
    ]
    ...
    with sweep.product:
        ACT_Config.chunk_size = [50, 100, 150, 200]
...
def tail(RUN, TrainArgs, ACT_Config):
    RUN.prefix, RUN.job_name, _ = RUN(
        ...
        job_name=f"corl_2025/pick_place_v1/{time:%Y/%m/%d/%H-%M-%S}/chunksize-{ACT_Config.chunk_size}/lr-{ACT_Config.lr:0.0e}/kl-{ACT_Config.kl_weight:0.0e}/{TrainArgs.seed}",
    )
