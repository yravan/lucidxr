...
with Sweep(RUN, TrainArgs, ACT_Config) as sweep:
    ...
    TrainArgs.dataset_prefix = [
        "lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place/2025/06/21/16.04.23/"
    ]
    ...
    with sweep.product:
        ...
        with sweep.product:
            ACT_Config.image_keys = [("left/rgb", "wrist/rgb", "front/rgb"), ("right/rgb", "wrist/rgb", "front/rgb")]
...
def tail(RUN, TrainArgs, ACT_Config):
    cam_id = 0
    if ACT_Config.image_keys == ("left/rgb", "wrist/rgb", "front/rgb"):
        cam_id = 1
