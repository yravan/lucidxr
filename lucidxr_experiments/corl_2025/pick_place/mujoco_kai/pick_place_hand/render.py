...
config = dict(
    name="pick_place_hand",
    env_name="PickPlaceHand-block_rand-v1",
    camera_keys=["front/rgb", "right/rgb", "wrist/rgb"],
)

demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place_hand/2025/07/01/13.20.25/"
demo_ep_start = 1
demo_ep_end = 25
...
num_render_workers = 25
render_worker_chain_length = 6
overwrite = True

from zaku import TaskQ
mujoco_queue_name = "kmcclenn:lucidxr:hand:mujoco-queue-1"
