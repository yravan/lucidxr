...
with Sweep(RUN, TrainArgs, ACT_Config) as sweep:
    ...
    TrainArgs.dataset_prefix = ["lucidxr/lucidxr/datasets/lucidxr/corl-2025/particle_pour/2025/07/02/22.03.43/"]
    ...
    ACT_Config.image_keys = ["wrist/domain_rand", "left/domain_rand", "right/domain_rand"]
    with sweep.product:
