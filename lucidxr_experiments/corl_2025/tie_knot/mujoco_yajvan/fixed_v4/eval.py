...
checkpoints = {
    "/lucidxr/lucidxr/corl_2025/tie_knot/mujoco_yajvan/fixed_v4/learn/2025/06/30/14-44-39/chunksize-50/lr-5e-05/kl-1e+01/42/checkpoints/policy_last.pt": "chunksize-50",
    "/lucidxr/lucidxr/corl_2025/tie_knot/mujoco_yajvan/fixed_v4/learn/2025/06/30/14-09-37/chunksize-100/lr-5e-05/kl-1e+01/42/checkpoints/policy_last.pt": "chunksize-100",
    "/lucidxr/lucidxr/corl_2025/tie_knot/mujoco_yajvan/fixed_v4/learn/2025/06/30/14-44-39/chunksize-150/lr-5e-05/kl-1e+01/42/checkpoints/policy_last.pt": "chunksize-150"
}
...
if __name__ == "__main__":
    with Sweep(RUN, Unroll, ACT_Config) as sweep:
        ...
        with sweep.product:
            with sweep.zip:
                Unroll.env_name = ["TieKnot-v1", "TieKnot-domain_rand-v1"]
