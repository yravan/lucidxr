...
config = dict(
    name="pick_place",
    env_name="PickPlace-v1",
    camera_keys=["wrist/rgb", "left/rgb", "right/rgb"],
)

demo_prefix = "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/pick_place/2025/06/21/16.04.23/"
demo_ep_start = 1
demo_ep_end = 66

num_render_workers = 66
render_worker_chain_length = 10
overwrite = True
