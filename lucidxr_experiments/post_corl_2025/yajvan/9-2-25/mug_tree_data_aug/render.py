...
demo_prefixes = [
    ...
    # "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/07/25/11.43.11_1",
    # "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/07/25/11.43.11_2",
    # "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/07/25/11.43.11_3",
    # "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/07/25/11.43.11_4",
    # "/lucidxr/lucidxr/datasets/lucidxr/corl-2025/mug_tree/2025/07/25/11.43.11_5",
]

demo_ep_start = 1
demo_ep_end = 50

num_render_workers = 100
render_worker_chain_length = 4
...
def main():
    ...
    mujoco_queue.clear_queue_safely()
    weaver_queue.clear_queue_safely()
