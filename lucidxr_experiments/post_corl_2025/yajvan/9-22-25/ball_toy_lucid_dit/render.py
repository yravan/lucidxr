...
configs = [
    dict(
        ...
        env_name="BallSortingToyNew-ball_random-gsplat-cic_12th_coffee_table",
        camera_keys=[
            "left/splat_rgb-cic_12th_coffee_table",
            "wrist/splat_rgb-cic_12th_coffee_table",
            "right/splat_rgb-cic_12th_coffee_table",
        ],
        dry_run=False,
        overwrite=False,
    ),
    dict(
        name="ball_sorting_toy_new",
        env_name="BallSortingToyNew-ball_random-gsplat-cic_11th_kitchen_back",
        camera_keys=[
            "left/splat_rgb-cic_11th_kitchen_back",
            "wrist/splat_rgb-cic_11th_kitchen_back",
            "right/splat_rgb-cic_11th_kitchen_back",
        ],
        dry_run=False,
        overwrite=False,
    ),
    dict(
        name="ball_sorting_toy_new",
        env_name="BallSortingToyNew-ball_random-gsplat-google_building_table",
        camera_keys=[
