...
checkpoints = {
    ...
    "/lucidxr/lucidxr/corl_2025/mug_tree/mujoco_yajvan/randomized_v3/learn/2025/06/29/17-12-56/chunksize-100/lr-5e-05/kl-1e+01/42/checkpoints/policy_last.pt": "chunksize-100",
...
if __name__ == "__main__":
    with Sweep(RUN, Unroll, ACT_Config) as sweep:
        ...
        with sweep.product:
            with sweep.zip:
                Unroll.env_name = ["MugTree-mug_rand-v1", "MugTree-mug_rand-domain_rand-v1"]
