...
from vuer_mujoco.neverwhere.gs_utils import DefaultStrategy
...
class Model(nn.Module):
    ...
    def load_ckpt(self, ckpt):  # type: ignore
        ...
        # from vuer_mujoco.scripts.util.gs_utils import load_gaussians
        # path = "/home/exx/fortyfive/lucidxr/vuer_mujoco/tasks/assets/eval_envs/cic_kitchen/3dgs/model-cleaned.splat"
        # x = load_neverwhere_splat(path, self.device)
