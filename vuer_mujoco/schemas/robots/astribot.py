...
from vuer_mujoco.schemas.robots.shadow_hand import ShadowHandLeft
...
class Astribot(Body):
    ...
    <asset>
      <mesh name="{name}-astribot_torso_base_link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/astribot_torso_base_link.stl"/>
      <mesh name="{name}-wheel_RF_Link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/wheel_RF_Link.stl"/>
      <mesh name="{name}-wheel_LF_Link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/wheel_LF_Link.stl"/>
      <mesh name="{name}-wheel_RR_Link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/wheel_RR_Link.stl"/>
      <mesh name="{name}-wheel_LR_Link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/wheel_LR_Link.stl"/>
      <mesh name="{name}-astribot_torso_link_1" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/astribot_torso_link_1.stl"/>
      <mesh name="{name}-astribot_torso_link_2" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/astribot_torso_link_2.stl"/>
      <mesh name="{name}-astribot_torso_link_3" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/astribot_torso_link_3.stl"/>
      <mesh name="{name}-astribot_torso_link_4" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_torso/astribot_torso_link_4.stl"/>
      <mesh name="{name}-astribot_head_base_link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_head/astribot_head_base_link.stl"/>
      <mesh name="{name}-astribot_head_link_1" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_head/astribot_head_link_1.stl"/>
      <mesh name="{name}-astribot_head_link_2" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_head/astribot_head_link_2.stl"/>
      <mesh name="{name}-astribot_arm_left_base_link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_left_base_link.stl"/>
      <mesh name="{name}-astribot_arm_right_base_link" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_right_base_link.stl"/>
      <mesh name="{name}-astribot_arm_link_1" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_1.stl"/>
      <mesh name="{name}-astribot_arm_left_link_2" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_left_link_2.stl"/>
      <mesh name="{name}-astribot_arm_link_3" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_3.stl"/>
      <mesh name="{name}-astribot_arm_link_4" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_4.stl"/>
      <mesh name="{name}-astribot_arm_link_5" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_5.stl"/>
      <mesh name="{name}-astribot_arm_link_6" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_6.stl"/>
      <mesh name="{name}-astribot_arm_link_7" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_link_7.stl"/>
      <mesh name="{name}-astribot_arm_right_link_2" content_type="model/stl" file="{assets}/astribot_config/robot_config/astribot_s1/meshes/s1_arm/astribot_arm_right_link_2.stl"/>
      <mesh name="{name}-gripper_base_link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_base_link.stl"/>
      <mesh name="{name}-gripper_L1_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_L1_Link.stl"/>
      <mesh name="{name}-gripper_L11_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_L11_Link.stl"/>
      <mesh name="{name}-gripper_L2_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_L2_Link.stl"/>
      <mesh name="{name}-gripper_R1_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_R1_Link.stl"/>
      <mesh name="{name}-gripper_R11_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_R11_Link.stl"/>
      <mesh name="{name}-gripper_R2_Link" content_type="model/stl" file="{assets}/astribot_gripper/meshes/astribot_gripper_R2_Link.stl"/>
    </asset>
    """
    ...
    def __init__(self, *_children, end_effector: Xml = None, head_mocap_quat=None, **kwargs):
        ...
        self.head_mocap_quat = " ".join([str(x) for x in head_mocap_quat] or [1, 0, 0, 0])
...
