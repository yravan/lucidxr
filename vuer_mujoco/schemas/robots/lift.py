...
class Lift(Body):
    ...
    def __init__(self, *_children, end_effector: Xml = None, mocap_pos=None, right_hand=True, left_hand=True, head=True, **kwargs,):
...
if __name__ == "__main__":
    ...
    scene = LiftRobot()
    output_path = "../../tasks/lift.mjcf.xml"
