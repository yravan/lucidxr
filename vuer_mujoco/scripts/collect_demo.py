...
if __name__ == "__main__":
    ...
    # Params.name = "mug_tree_aligned"
    # Params.entry_file = "mug_tree_aligned.mjcf.xml"
    # Params.factory_fn = "vuer_mujoco.tasks.mug_tree_aligned:make_schema"
    # Params.init_fn = "vuer_mujoco.tasks.mug_tree_aligned:MugRandom"
    ...
    Params.factory_fn = "vuer_mujoco.tasks.tri_demo_kitchen_room_shadow_hands:make_schema"
    Params.init_fn = "vuer_mujoco.tasks.tri_demo_kitchen_room_shadow_hands:CleanSink"

    # Params.name = "tri_demo_ur5_tabletop"
    # Params.factory_fn = "vuer_mujoco.tasks.tri_demo_ur5_tabletop:make_schema"
    # Params.init_fn = "vuer_mujoco.tasks.tri_demo_ur5_tabletop:Fixed"

    # Params.name = "ball_sorting_toy_new"
    # # Params.entry_file = "tie_knot.mjcf.xml"
    # Params.factory_fn = "vuer_mujoco.tasks.ball_sorting_toy_new:make_schema"
    # Params.init_fn = "vuer_mujoco.tasks.pour_liquid:Fixed"
    # Params.init_fn = "vuer_mujoco.tasks.ball_sorting_toy_new:BallRandom"
    ...
    # Params.init_fn = "vuer_mujoco.tasks.kitchen_room:BallRandom"
