...
def rotation_matrix(angle, direction, point=None):
    ...
    E.g.:
        >>> angle = (random.random() - 0.5) * (2*math.π)
        >>> direc = numpy.random.random(3) - 0.5
        >>> point = numpy.random.random(3) - 0.5
        >>> R0 = rotation_matrix(angle, direc, point)
        >>> R1 = rotation_matrix(angle-2*math.π, direc, point)
        ...
        >>> numpy.allclose(I, rotation_matrix(math.π*2, direc))
        True

        >>> numpy.allclose(2., numpy.trace(rotation_matrix(math.π/2,
        ...                                                direc, point)))
        True
